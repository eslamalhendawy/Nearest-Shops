    ...
    <section className='bg-primary mb-12'>
      <div className='container mx-auto px-4 py-4 md:py-0 flex items-center justify-center gap-[100px] xl:gap-[200px]'>
        <div className="text-center md:text-left">
          ...
          <Link to="/collection" className="bg-secondary text-white py-3 px-7 block w-fit mx-auto md:mx-[0px]">Shop Collection</Link>
        </div>
        <div className="hidden md:block max-w-[400px] xl:max-w-[600px] relative">
          <img src={heroImage} alt="" />
          <div className="size-[300px] rounded-full bg-white absolute" />
        </div>
      </div>
    </section>
  )
