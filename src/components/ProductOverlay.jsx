    ...
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)}>
        <div className="flex justify-center items-center min-h-screen">
          <div className="bg-white flex flex-col sm:flex-row sm:items-center relative w-[250px] sm:w-[600px] md:w-[720px] xl:w-[1000px]">
            ...
            <div className="basis-1/2 p-4 flex flex-col justify-between">
              ...
              <Link to={`/product/${data.slug}`} className="block bg-secondary hover:bg-accent duration-200 w-fit mx-auto text-white py-2 px-6">See More</Link>
            </div>
          </div>
        </div>
      </Modal>
